...
class DataConfig:
    ...
    cap_prompt_key: str = "prompt"
    cap_answer_key: str = "answer"
    seg_prompt_key: str = "prompt"
    seg_answer_key: str = "answer"
...
class PPOConfig:
    ...
    def post_init(self):
        ...
        self.worker.actor.caption_anchor_kl_coef = self.worker.opsd.caption_anchor_kl_coef
