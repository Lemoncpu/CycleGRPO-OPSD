            ...
            [
                {
                    ...
                    "content": [
                        ...
                        {"type": "text", "text": f"""All spatial relationships are defined from the viewer's perspective, where 'front' means closer to the viewer and 'back' means farther from the viewer. Please provide the segmentation mask of the object the following statement describes:\n{sample['phrase']}\nEnsure that all details mentioned about the object are accurate. If a matching object is found, provide its segmentation mask in the format `<|mt_start|><|mt_xxxx|><|mt_xxxx|><|mt_end|>`. If no matching object is found, output null."""},
                    ],
                }
            ]
