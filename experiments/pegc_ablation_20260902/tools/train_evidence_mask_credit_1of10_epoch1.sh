...
# 1/10, one-epoch baseline + evidence gate + hierarchical mask credit.
...
RUN_ROOT="${REPO_DIR}/logs/pegc_evidence_mask_credit_1of10_epoch1"
...
SAVE_FREQ=18 \
SAVE_LIMIT=3 \
RUN_NAME=pegc_evidence_mask_credit_1of10_epoch1 \
RUN_ROOT="${REPO_DIR}/logs/pegc_evidence_mask_credit_1of10_epoch1" \
