...
# 1/10, one-epoch evidence gate + hierarchical mask credit with isolated
# positive-empty penalties. GPU0-2 train and GPU3 runs the DLC judge.
...
RAY_SHORT_ROOT="${RAY_SHORT_ROOT:-/dev/shm/pegc-iso-g012}"
RUN_ROOT="${REPO_DIR}/logs/pegc_evidence_mask_credit_cycle_pos1_direct_pos0_1of10_epoch1"
...
SAVE_FREQ=18 \
SAVE_LIMIT=3 \
RUN_NAME=pegc_evidence_mask_credit_cycle_pos1_direct_pos0_1of10_epoch1 \
RUN_ROOT="${REPO_DIR}/logs/pegc_evidence_mask_credit_cycle_pos1_direct_pos0_1of10_epoch1" \
