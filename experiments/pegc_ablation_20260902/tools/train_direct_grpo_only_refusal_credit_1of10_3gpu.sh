...
# 1/10, one-epoch supervised Refusal Credit: direct GRPO only (no Mask CE/Credit/DLC-QA).
# GPU0-2 train and GPU3 hosts the local Llama service.
...
RUN_ROOT="${REPO_DIR}/logs/pegc_direct_grpo_only_refusal_credit_1of10_epoch1"
...
SAVE_FREQ=18 \
SAVE_LIMIT=3 \
RUN_NAME=pegc_direct_grpo_only_refusal_credit_1of10_epoch1 \
RUN_ROOT="${REPO_DIR}/logs/pegc_direct_grpo_only_refusal_credit_1of10_epoch1" \
