...
# 1/10, one-epoch supervised baseline: direct GRPO only (no Mask CE/Credit/DLC-QA).
...
RUN_ROOT="${REPO_DIR}/logs/pegc_direct_grpo_only_baseline_1of10_epoch1"
...
SAVE_FREQ=18 \
SAVE_LIMIT=3 \
RUN_NAME=pegc_direct_grpo_only_baseline_1of10_epoch1 \
RUN_ROOT="${REPO_DIR}/logs/pegc_direct_grpo_only_baseline_1of10_epoch1" \
