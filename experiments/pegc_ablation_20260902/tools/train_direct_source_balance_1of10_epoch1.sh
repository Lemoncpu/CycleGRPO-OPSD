...
# 1/10, one-epoch baseline + source-balanced direct credit.
...
RUN_ROOT="${REPO_DIR}/logs/pegc_direct_source_balance_1of10_epoch1"
...
CONDA_PREFIX=/volume/ybo/xyc/envs/cyclegrpo \
...
DIRECT_SOURCE_BALANCE_ENABLED=true \
DIRECT_SOURCE_BALANCE_POSITIVE_FRACTION=0.5 \
DIRECT_SOURCE_BALANCE_MIN_WEIGHT=0.5 \
DIRECT_SOURCE_BALANCE_MAX_WEIGHT=2.0 \
CBBA_ENABLED=false \
MAX_STEPS="${MAX_STEPS:-18}" \
TOTAL_EPOCHS=1 \
SAVE_FREQ=18 \
SAVE_LIMIT=3 \
RUN_NAME=pegc_direct_source_balance_1of10_epoch1 \
RUN_ROOT="${REPO_DIR}/logs/pegc_direct_source_balance_1of10_epoch1" \
